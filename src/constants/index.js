...
//     image: project2,
//     description:
//       "A task management application designed to help users organize their daily activities efficiently. Features include task creation, editing, and tracking, utilizing React’s state management.",
//     technologies: ["ReactJS", "CSS", "JavaScript", "Firebase"],
//   },
//   {
//     title: "E-Commerce Website (Web3Bridge Capstone)",
//     image: project3,
//     description:
//       "A complete e-commerce platform with features like product filtering, shopping cart, and checkout functionality, designed using ReactJS. This project showcases my ability to work on complex applications with a desktop-first approach.",
//     technologies: ["ReactJS", "CSS", "JavaScript", "Git"],
//   },
//   {
//     title: "Portfolio Website",
//     image: project4,
//     description:
//       "A personal portfolio website that showcases my projects, skills, and contact information. Built using ReactJS and CSS, it reflects my front-end development expertise and eye for design.",
